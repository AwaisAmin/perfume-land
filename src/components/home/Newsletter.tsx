      ...
      <div className="container-app flex flex-col items-center text-center">
        ...
        >
          ...
          <input
            ...
            className="w-full rounded-full border border-cream-50/40 bg-transparent px-5 py-3 text-sm text-cream-50 placeholder:text-cream-50/70 focus:border-cream-50 focus:outline-none"
          />
          <button
            type="submit"
            className="shrink-0 rounded-full bg-forest-900 px-6 py-3 text-xs font-semibold uppercase tracking-[0.14em] text-gold-400 transition hover:bg-forest-950"
          >
